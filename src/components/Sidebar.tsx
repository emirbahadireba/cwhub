...
export const Sidebar: React.FC = () => {
  ...
  const handleLogout = () => {
    ...
    // Could also clear localStorage, redirect to login page, etc.
  }
  ...
  return (
    <div className="w-64 min-h-screen bg-surface border-r border-border flex flex-col relative">
      {/* Logo & Brand */}
      <div className="p-6">
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className={`font-medium ${notification.read ? 'text-textSecondary' : 'text-white'}`}>
                              {notification.title}
                            </p>
                            <p className="text-textSecondary text-sm mt-1 truncate">
